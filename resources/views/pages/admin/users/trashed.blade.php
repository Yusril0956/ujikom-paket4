                ...
                <nav class="flex items-center gap-2">
                    ...
                    @else
                        <a href="{{ $users->previousPageUrl() }}"
                            class="px-3 py-1.5 border border-ink text-xs font-mono text-coffee hover:bg-ink/5 hover:text-ink transition-colors rounded">← Prev</a>
                    @endif
                    ...
                    @if ($users->hasMorePages())
                        <a href="{{ $users->nextPageUrl() }}"
                            class="px-3 py-1.5 border border-ink text-xs font-mono text-coffee hover:bg-ink/5 hover:text-ink transition-colors rounded">Next →</a>
                    @else
                        <span
                            class="px-3 py-1.5 border border-ink text-xs font-mono text-muted rounded opacity-50 cursor-not-allowed">Next →</span>
                    @endif
                </nav>
            </div>
        @endif
